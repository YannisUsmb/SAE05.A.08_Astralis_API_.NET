        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    plt_id = table.Column<int>(type: "integer", nullable: false),
                    dem_id = table.Column<int>(type: "integer", nullable: false),
                    pla_distance = table.Column<decimal>(type: "numeric(20,10)", nullable: true),
                    ...
                    pla_radius = table.Column<decimal>(type: "numeric(20,10)", nullable: true),
                    pla_temperature = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    ...
                    pla_hoststartemperature = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    pla_hoststarmass = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
