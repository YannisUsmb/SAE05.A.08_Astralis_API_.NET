    ...
    public class MapperProfile : Profile
    {
        public MapperProfile()
        {
            ...
            CreateMap<CelestialBody, CelestialBodyDetailDto>()
                .ForMember(dest => dest.CelestialBodyTypeName,
                    opt => opt.MapFrom(src => src.CelestialBodyTypeNavigation.Label))
                .ForMember(dest => dest.Planet,
                    opt => opt.MapFrom(src => src.PlanetNavigation))
                .ForMember(dest => dest.Star,
                    opt => opt.MapFrom(src => src.StarNavigation))
                .ForMember(dest => dest.Asteroid,
                    opt => opt.MapFrom(src => src.AsteroidNavigation))
                .ForMember(dest => dest.Satellite,
                    opt => opt.MapFrom(src => src.SatelliteNavigation))
                .ForMember(dest => dest.GalaxyQuasar,
                    opt => opt.MapFrom(src => src.GalaxyQuasarNavigation))
                .ForMember(dest => dest.Comet,
                    opt => opt.MapFrom(src => src.CometNavigation))
                .ForMember(dest => dest.Discovery,
                    opt => opt.MapFrom(src => src.DiscoveryNavigation));
            ...
            CreateMap<Product, ProductDetailDto>()
                ...
                .ForMember(dest => dest.CategoryLabel, opt => opt.MapFrom(src => src.ProductCategoryNavigation.Label))
                .ForMember(dest => dest.CategoryDescription, opt => opt.MapFrom(src => src.ProductCategoryNavigation.Description));
            // DTO to Entity (Write).
            ...
            CreateMap<UserNotification, UserNotificationDto>()
                .ForMember(dest => dest.Title, opt => opt.MapFrom(src => src.NotificationNavigation.Label))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.NotificationNavigation.Description))
                .ForMember(dest => dest.Link, opt => opt.MapFrom(src => src.NotificationNavigation.Link))
                .ForMember(dest => dest.TypeLabel, opt => opt.MapFrom(src => src.NotificationNavigation.NotificationTypeNavigation.Label));
            // DTO to Entity (Write).
